...
class TestPrepData(unittest.TestCase):       
    ...
    def test_datetime2date(self):
        print('Er nå inne i datetime2date som ikke er ferdig implementert')
        table_name = "MY_TABLE"
        test_n = 10 
    ...
    def test_preprocess_data(self):
        ...
        test_data['str_datetime_with_na2'] = test_data['str_datetime_with_na']
        data_types = Datatype.robust_get_data_type_from_values(test_data)
        date_cols = [col for col in data_types if data_types[col] == "datetime.date"]
        ...
        timestamp_cols = ['str_datetime_with_na2']
