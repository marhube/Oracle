...
class TestSQL(unittest.TestCase): 
    ...
    def test_map2db_dtype(self):
        ...
        db_data_types_comparison['str_only_na']  = 'VARCHAR2(255)'
    ...
    def test_sql_create_table(self):
        ...
        sql_generator = SQL_Generator(
            test_data.dtypes,table_name=table_name,table_type = "PRIVATE")
        sql_create = SQL_Create(sql_generator)
    ...
    def test_parse_complex_sql_code(self):
        print('Er nå inne i TestSQL.test_parse_complex_sql_code som ikke er implementert')
