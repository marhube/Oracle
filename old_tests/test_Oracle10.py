...
class TestOracle(unittest.TestCase):
    ...
    def test_init_SQL_Generator(self):
        ...
        table_name = "MY_TABLE"
        sql_gen_commit = Oracle.SQL_Generator(df.dtypes,table_name=table_name)
        print('Klarte forhåpentlig å instansiere SQL_Generator')
        print(f'dir(sql_gen_commit) er {dir(sql_gen_commit)}')
        print(f'sql_gen_commit.db_dtypes er {sql_gen_commit.db_dtypes}')
        self.assertIsInstance(sql_gen_commit,Oracle.SQL_Generator)
    ...
    def test_create_or_replace_persistent_table(self):
        ...
        oracle_connect.create_or_replace_persistent_table(df.copy(),table_name = "MY_TEST_TABLE")
