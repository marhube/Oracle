...
class SQL_Generator:
    ...
    def __init__(
        self,
        dtypes,table_name,table_type='PRIVATE',datetime2date=True,varchar_size=255,
...
class SQL_Parser:
    ...
    def remove_comments_and_empty_lines(sql_code):
    ...
    class StatementHandler:
        def __init__(self, statement = "", current_block=[], execution_order=[]):
        ...
        def update_statement(self,statement):
            ...
            return self
        # 
        def is_control_structure_start(self):
        ...
        #
        def handle_control_structure(self): 
            if self.statement == '/':
            ...
            return self
        #
        def handle_individual_statement(self):
            ...
            return self                                  
    #    
    def split_on_control_structures(self):
