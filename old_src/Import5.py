...
#******* Start internimport
from Oracle.SQL import SQL_Generator,SQL_Create
...
class PreprocessData(SQL_Generator):    
    ...
    def preprocess_date_values(self,date_values: pd.Series) -> pd.Series:
        ...
        percent_format = PrepData.replace_time_format(self.date_format)
    ...
    def preprocess_datetime_values(self,datetime_values: pd.Series) -> pd.Series:
        percent_format = PrepData.replace_time_format(self.timestamp_format)
    ...
    def create_user_table(self,conn: oracledb.Connection) -> None:
        print('Er nå inne i SQL_Insert.create_table()')
        sql_create = SQL_Create(self)
